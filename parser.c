...
//void skip_blank_lines(){ TODO: funkce pro skip EOL
//	while(token.t_state == EOL){
//		generate_token();
//	}
//}
        			...
        			if(token.t_state == st_pravzav){
        				...
        				if(token.t_state == st_as){
        					...
        					if(rule_type()){
        						...
        						if(token.t_state == ){ //TODO: jak resime EOL?
        							generate_token();
        							return_value = true;
        						}
        					}
...
bool rule_stat(){ // stav <stat>
    ...
    if(token.t_state == st_dim ){ // simulace pravidla 18.
    	...
    	if( /* FUNKCE PRO VYRAZY*/ ){ // TODO: EXPRESSION!!!! 
...
bool rule_assign(){ // stav <assign>
	bool return_value = false;
    if( /* FUNKCE PRO VYRAZY*/ ){ // TODO: EXPRESSION!!!! //simulace pravidla 22.
    			// TODO: musim tady generovat token?
        	return_value = true;
    	}
...
bool rule_pr_expr(){ // stav <pr-expr>
	bool return_value = false;
    if( /* FUNKCE PRO VYRAZY*/ ){ // TODO: EXPRESSION!!!! //simulace pravidla 30.
    			// TODO: musim tady generovat token?
